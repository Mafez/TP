...
public class Main {
	...
	private static Option constructApplicationOption() {
		/**
		 *  Hay que usar aqui DEFAULT_APPMODE para averiguar el modo de la apliacion?
		 */
		 ...
		 * o...?
		 */
		/*return new Option("app-mode", "am", true,
	...
	*/
			...
			if (dimRows != null && dimCols != null) {
				if(dimRows % 2 != 0 && dimCols % 2 != 0) { // Comprobamos que sean dimensiones con valor impar:
					if(obstacles != null) {
						...
						gameFactory = new AtaxxFactoryExt(dimRows, dimCols, 0);
					}
				} else {
	...
	private static void startClient() {
		try {
			...
			System.err.println("Fallo al intentar iniciar el cliente" + e.getMessage()); // Aqui es donde se muestra el mensaje de error
		}
	}
